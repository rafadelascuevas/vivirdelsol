...
(function() {
    ...
    Lorem.prototype.createText = function(count, type, dict) {
        var wordIndex;
        switch (type) {
            ...
            case Lorem.TYPE.PARAGRAPH:
                ...
                for (var i = 0; i < count; i++) {
                    ...
                    var paragraph = this.createText(paragraphLength, Lorem.TYPE.SENTENCE, dict);
            ...
            case Lorem.TYPE.WORDSENTENCE:
                var sentences = new Array;
                var wordsLength;
                if (type == Lorem.TYPE.WORDSENTENCE){
                    wordsLength = count
                    count = 1
                }
                for (var i = 0; i < count; i++) {
                    var sentenceLength = wordsLength || this.randomInt(5, 10);
                    var words = this.createText(sentenceLength, Lorem.TYPE.WORD, dict).split(' ');
            ...
            case Lorem.TYPE.WORD:
                dict = dict || Lorem.DICTS.Ipsum
                wordIndex = this.randomInt(0, dict.length - count - 1);

                return dict.slice(wordIndex, wordIndex + count).join(' ').replace(/\.|\,/g, '');
                break;
            case Lorem.TYPE.ELEMENT:
                dict = dict || Lorem.DICTS.Ipsum
                wordIndex = this.randomInt(0, dict.length - count - 1);

                return dict.slice(wordIndex, wordIndex + count).join('\n');
        }
    };
